        ...
        <div class="row">
			...
			<div class="col-lg-4 col-sm-4">
                <section>
                    <div class="f-box">
                        <i class="fa fa-gears"></i>
                        <h2>Surat Pindah Keluar</h2>
                    </div>
                    <p class="f-text">
					Surat Pindah Warga Surakarta yang Akan Pindah ke Daerah Lain dalam satu Kelurahan, 
					antar Kelurahan dalam satu Kecamatan, antar Kecamatan dalam satu kota Surakarta,
					antar Kabupaten/ kota dalam satu Provinsi, antar Provinsi dalam wilayah Indonesia.
					</p>
                </section>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-6">
                    <h1>Data Grafik & Monitoring Berkas Anda</h1>
                    <p>Data Grafik Statistik Penduduk Kota Surakarta Kami Tapilkan Pada Website Ini. Serta
					monitoring berkas pengajuan anda secara online. Lihat dimana berkas anda! apakah disetujui 
					atau terdapat penolakan dari dinas terkait.</p>
                    <a href="javascript:;" class="btn btn-purchase">Lihat Sekarang !</a>
                </div>
            </div>
        </div>
    </div>
