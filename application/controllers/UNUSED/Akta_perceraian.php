...
class Akta_perceraian extends CI_Controller
{
    ...
    {
        $akta_perceraian = $this->Akta_perceraian_model->get_all();

        $data = array(
            'akta_perceraian_data' => $akta_perceraian
        );

        $this->load->view('akta_perceraian_list', $data);
    }

    public function read($id) 
    {
        $row = $this->Akta_perceraian_model->get_by_id($id);
        if ($row) {
            $data = array(
		'id_ac' => $row->id_ac,
		...
		'ip_network' => $row->ip_network,
            ...
            $this->load->view('akta_perceraian_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('akta_perceraian'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('akta_perceraian/create_action'),
        ...
        $this->load->view('akta_perceraian_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('akta_perceraian/update_action'),
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->update($this->input->post('id_ac', TRUE));
        } else {
            $data = array(
		'nik_pengaju' => $this->input->post('nik_pengaju',TRUE),
		'nama' => $this->input->post('nama',TRUE),
		...
		'ip_network' => $this->input->post('ip_network',TRUE),
            ...
            $this->Akta_perceraian_model->update($this->input->post('id_ac', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Akta_perceraian_model->delete($id);
	...
	$this->form_validation->set_rules('id_ac', 'id_ac', 'trim');
	$this->form_validation->set_error_delimiters('<span class="text-danger">', '</span>');
    }

}

/* End of file Akta_perceraian.php */
/* Location: ./application/controllers/Akta_perceraian.php */
