...
class Data_perkawinan2 extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('Data_perkawinan2_model');
        $this->load->library('form_validation');
    }

    public function index()
    {
        $data_perkawinan2 = $this->Data_perkawinan2_model->get_all();

        $data = array(
            'data_perkawinan2_data' => $data_perkawinan2
        );
    ...
    {
        $row = $this->Data_perkawinan2_model->get_by_id($id);
        if ($row) {
            $data = array(
		...
		'nama_pemuka' => $row->nama_pemuka,
            ...
            redirect(site_url('data_perkawinan2'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('data_perkawinan2/create_action'),
    ...
    public function create_action() 
    {
		...
		'nama_pemuka' => $this->input->post('nama_pemuka',TRUE),
            ...
            $this->Data_perkawinan2_model->insert($data);
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('data_perkawinan2/update_action'),
    ...
    public function update_action() 
    {
		...
		'nama_pemuka' => $this->input->post('nama_pemuka',TRUE),
            ...
            $this->Data_perkawinan2_model->update($this->input->post('id_dataper', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Data_perkawinan2_model->delete($id);
...
/* End of file Data_perkawinan2.php */
/* Location: ./application/controllers/Data_perkawinan2.php */
