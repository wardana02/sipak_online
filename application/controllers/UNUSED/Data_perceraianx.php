...
class Data_perceraianx extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('Data_perceraianx_model');
        $this->load->library('form_validation');
    }

    public function index()
    {
        $data_perceraianx = $this->Data_perceraianx_model->get_all();

        $data = array(
            'data_perceraianx_data' => $data_perceraianx
        );
    ...
    {
        $row = $this->Data_perceraianx_model->get_by_id($id);
        if ($row) {
            $data = array(
		'id_datacerai' => $row->id_datacerai,
		'id_ac' => $row->id_ac,
		'yang_mengajukan' => $row->yang_mengajukan,
		...
		'tgl_melapor' => $row->tgl_melapor,
            ...
            redirect(site_url('data_perceraianx'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('data_perceraianx/create_action'),
	    'id_datacerai' => set_value('id_datacerai'),
	    'id_ac' => set_value('id_ac'),
	    'yang_mengajukan' => set_value('yang_mengajukan'),
    ...
    public function create_action() 
    {
		...
		'yang_mengajukan' => $this->input->post('yang_mengajukan',TRUE),
		...
		'tgl_melapor' => $this->input->post('tgl_melapor',TRUE),
            ...
            $this->Data_perceraianx_model->insert($data);
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('data_perceraianx/update_action'),
		'id_datacerai' => set_value('id_datacerai', $row->id_datacerai),
		'id_ac' => set_value('id_ac', $row->id_ac),
		'yang_mengajukan' => set_value('yang_mengajukan', $row->yang_mengajukan),
    ...
    public function update_action() 
    {
		...
		'tgl_melapor' => $this->input->post('tgl_melapor',TRUE),
            ...
            $this->Data_perceraianx_model->update($this->input->post('id_datacerai', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Data_perceraianx_model->delete($id);
...
/* End of file Data_perceraianx.php */
/* Location: ./application/controllers/Data_perceraianx.php */
