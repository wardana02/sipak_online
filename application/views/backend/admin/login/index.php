<html>
  ...
  <body background="<?=base_url('assets/img/balaikota.jpg')?>" style="background-repeat:no-repeat center center fixed; 
 background-size:cover";>

    <div class="login-box">
      <div class="login-logo">
      <div class="box">
        <a href='#'><b>AKTA ONLINE<br></b>Pelayanan Disdukcapil Surakarta</a>
        </div>

      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Masuk Menggunakan Username dan Password anda untuk mengakses</p>
        ...
        <form action=<?=base_url('index.php/login/index');?> method="post">
          <div class="form-group has-feedback">
            <input type="text" name="username" class="form-control" placeholder="Username" value="<?php echo set_value('username');?>" onkeypress="return karakter(event)" required />
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            <?php echo form_error('username', '<p class="field_error">', '</p>');?>
          </div>

          <div class="form-group has-feedback">
            <input type="password" name="password" class="form-control" placeholder="Password" value="<?php echo set_value('password');?>" onkeypress="return karakter(event)" required />
        ...
        <p>Butuh Bantuan?<br>Kontak<b>KAMI : </b><br>0857 25 4858 10<br> (Aji Pratamax | D3 Teknik Informatika)</p>
        <!--
