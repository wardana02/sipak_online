      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Daftar Pesan Menunggu (Pending Message) Sistem SMS gateway
            <small></small>
          </h1>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-primary">
                ...
                <div class="box-body">
                <a href="<?= base_url("mail/pending"); ?>" class="btn btn-primary"><i class="glyphicon glyphicon-transfer"></i>  Muat Ulang Data/Refresh</a> 
                          ...
                          <td>
                              <div class="btn-group"> 
                                ...
                                <ul class="dropdown-menu" role="menu">
                                  ...
                                  <li><a href=<?php echo site_url('mail/delete_outbox/'.$kode->ID); ?> onclick="javasciprt: return confirm('Anda Yakin Menghapus Data SMS ini? ?')">Hapus</a></li>
                                </ul>
                              </div>     
                            </td>
