                                          ...
                                          <div class="modal-body">
                                              ...
                                              <form role="form" method="post" action="<?php echo $cek; ?>">
                                                  <div class="form-group">
                                                      ...
                                                      <input type="text" class="form-control" name="no_pendaftaran" value="PF12130416001 PF12170416002" placeholder="Masukan Nomor Pendaftaran Dengan Huruf Kapital">
                                                  </div>
                                                  <div class="form-group">
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <input type="text" name="kode_unik" class="form-control" value="8QAruh nzEDPj" id="exampleInputEmail3" placeholder="Kode Unik Pendaftaran Yang Didapat">
                                                  </div>
