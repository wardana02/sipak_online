                  ...
                  <!--DATA SUAMI DAN ORANGTUA NYA-->
                                  ...
                                  <div class="alert alert-info fade in">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                              <input type="text" name="s_nama_organisasi" disabled="" id="s_nama_organisasi" value="<?php echo $s_nama_organisasi; ?>" disabled="" required="" class="form-control tooltips" data-toggle="tooltip " data-original-title="Isi Dengan Nama Organisasi Penghayat Kepercayaan" >
                                      ...
                                      <div class="form-group">
                                          <label class="col-lg-2 control-label">Agama (Sesuai Pada Data KTP)</label>
                                          <div class="col-lg-10">
                                              <input type="text" name="as_agama" disabled="" id="as_agama" value="<?php echo $as_agama; ?>" disabled="" class="form-control tooltips" data-toggle="tooltip " data-original-title="Isi Dengan Nama Organisasi Penghayat Kepercayaan" >
                                      ...
                                      <div class="form-group">
                                          <label class="col-lg-2 control-label">Agama (Sesuai Pada Data KTP)</label>
                                          <div class="col-lg-10">
                                              <input type="text" name="is_agama" disabled="" id="is_agama" value="<?php echo $is_agama; ?>" disabled="" class="form-control tooltips" data-toggle="tooltip " data-original-title="Isi Dengan Nama Organisasi Penghayat Kepercayaan" >
                  ...
                  <!--DATA ISTRI DAN ORANGTUA NYA-->
                                  <fieldset title="Data Istri" class="step" id="default-step-1" >
                                      ...
                                      <div class="form-group">
                                          <label class="col-lg-2 control-label">Agama (Sesuai Pada Data KTP)</label>
                                          <div class="col-lg-10">
                                              <input type="text" name="ai_agama" disabled="" id="ai_agama" value="<?php echo $ai_agama; ?>" disabled="" class="form-control tooltips" data-toggle="tooltip " data-original-title="Isi Dengan Nama Organisasi Penghayat Kepercayaan" >
                                      ...
                                      <div class="form-group">
                                          <label class="col-lg-2 control-label">NIK</label>
                                          <div class="col-lg-8">
                                              <input type="text" name="ii_nik" value="3311112302960002" id="ii_nik" class="form-control tooltips" onkeypress="return runScript(event)" maxlength="16" value="<?php echo $ii_nik; ?>" data-toggle="tooltip " data-original-title="NIK Diisikan Tanpa Huruf & Spasi" required>
                                      ...
                                      <div class="form-group">
                                          <label class="col-lg-2 control-label">Agama (Sesuai Pada Data KTP)</label>
                                          <div class="col-lg-10">
                                              <input type="text" name="ii_agama" disabled="" id="ii_agama" value="<?php echo $ii_agama; ?>" disabled="" class="form-control tooltips" data-toggle="tooltip " data-original-title="Isi Dengan Nama Organisasi Penghayat Kepercayaan" >
                                      ...
                                      <div class="form-group">
                                          <label class="col-lg-2 control-label">Nama Organisasi Penghayat Kepecrayaan</label>
                                          <div class="col-lg-10">
                                              <input type="text" name="ii_nama_organisasi" id="ii_nama_organisasi" disabled="" class="form-control tooltips" value="<?php echo $ii_nama_organisasi; ?>" data-toggle="tooltip" data-original-title="Isi Dengan Nama Organisasi Penghayat Kepercayaan" >
                    ...
                    <!--DATA DUA ORANG SAKSI NYA-->
                                  ...
                                  <div class="alert alert-info fade in">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                              <input type="text" name="s1_nama" readonly="" id="s1_nama" value="<?php echo $s1_nama; ?>" class="form-control tooltips" data-toggle="tooltip" data-original-title="Isi Dengan Benar Nama Lengkap" >
                                               <input type="hidden" name="s1_umur" readonly="" id="s1_umur" value="<?php echo $s1_umur; ?>">
                                      ...
                                      <div class="form-group">
                                          <label class="col-lg-2 control-label">Agama (Sesuai Pada Data KTP)</label>
                                          <div class="col-lg-10">
                                              <input type="text" name="s1_agama" disabled="" id="s1_agama" value="<?php echo $s1_agama; ?>" disabled="" class="form-control tooltips" data-toggle="tooltip " data-original-title="Isi Dengan Nama Organisasi Penghayat Kepercayaan" >
                                      ...
                                      <div class="form-group">
                                          <label class="col-lg-2 control-label">Nama Organisasi Penghayat Kepecrayaan</label>
                                          <div class="col-lg-10">
                                              <input type="text" name="s1_nama_organisasi" id="s1_nama_organisasi" disabled="" class="form-control tooltips" value="<?php echo $s1_nama_organisasi; ?>" data-toggle="tooltip" data-original-title="Isi Dengan Nama Organisasi Penghayat Kepercayaan" >
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                              ...
                                              <input type="hidden" name="s2_umur" readonly="" id="s2_umur" value="<?php echo $s2_umur; ?>">
                                      ...
                                      <div class="form-group">
                                          <label class="col-lg-2 control-label">Agama (Sesuai Pada Data KTP)</label>
                                          <div class="col-lg-10">
                                              <input type="text" name="s2_agama" disabled="" id="s2_agama" value="<?php echo $s2_agama; ?>" disabled="" class="form-control tooltips" data-toggle="tooltip " data-original-title="Isi Dengan Nama Organisasi Penghayat Kepercayaan" >
