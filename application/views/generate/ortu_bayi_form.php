...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Ortu_bayi <?php echo $button ?></h2>
        <form action="<?php echo $action; ?>" method="post">
	    <div class="form-group">
            <label for="varchar">Id Bayi <?php echo form_error('id_bayi') ?></label>
            <input type="text" class="form-control" name="id_bayi" id="id_bayi" placeholder="Id Bayi" value="<?php echo $id_bayi; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
            <label for="date">Tgl Pencatatan Kawin <?php echo form_error('tgl_pencatatan_kawin') ?></label>
            <input type="text" class="form-control" name="tgl_pencatatan_kawin" id="tgl_pencatatan_kawin" placeholder="Tgl Pencatatan Kawin" value="<?php echo $tgl_pencatatan_kawin; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <a href="<?php echo site_url('ortu_bayi') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>