...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Ortu_mempelai <?php echo $button ?></h2>
        <form action="<?php echo $action; ?>" method="post">
	    <div class="form-group">
            <label for="varchar">Id Mempelai <?php echo form_error('id_mempelai') ?></label>
            <input type="text" class="form-control" name="id_mempelai" id="id_mempelai" placeholder="Id Mempelai" value="<?php echo $id_mempelai; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
            <label for="int">Nama Organisasi <?php echo form_error('nama_organisasi') ?></label>
	    ...
	    <a href="<?php echo site_url('ortu_mempelai') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>