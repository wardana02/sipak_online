...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Data_saksi <?php echo $button ?></h2>
	    ...
	    <input type="hidden" name="id_saksi" value="<?php echo $id_saksi; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('data_saksi') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>