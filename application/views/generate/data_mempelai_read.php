...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Data_mempelai Read</h2>
        <table class="table">
	    ...
	    <tr><td>Status Sebelum Nikah</td><td><?php echo $status_sebelum_nikah; ?></td></tr>
	    <tr><td>Perkawinan Ke</td><td><?php echo $perkawinan_ke; ?></td></tr>
	    <tr><td>Istri Ke</td><td><?php echo $istri_ke; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('data_mempelai') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
        </body>
</html>