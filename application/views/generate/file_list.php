    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('file/read/'.$file->id),'Read'); 
				echo ' | '; 
				echo anchor(site_url('file/update/'.$file->id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('file/delete/'.$file->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
